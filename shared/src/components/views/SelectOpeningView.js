...
const OpeningChoiceCard = ({ op, color, setSelectedOpening }) => {
  return (
    <TouchableOpacity
      style={{
        marginTop: 10,
      ...
      <View style={{ marginTop: 10, marginLeft: 15, width: '70%' }}>
        ...
        <Text
          ...
          The Caro-Kann Defense is a common defense against e4, characterized by
          d4 and c6. It aims for a solid, yet flexible position.
        </Text>
      </View>
    </TouchableOpacity>
  );
