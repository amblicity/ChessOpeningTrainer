...
import { usePlayerPlayingAs } from '../../state/selectors';
...
export const CurrentPlayView = () => {
  ...
  const allVariationsInOpening = useMemo(
    () => getAllVariationsByOpeningKey('CaroKann'),
    [],
  );
  ...
  const movesInVariation = useMemo(
    () => getMovesByOpeningAndVariationKey('CaroKann', 'QICK'),
    [],
  );
